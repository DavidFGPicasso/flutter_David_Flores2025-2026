...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Actividad 6',
      home: const TextoEstilizadoScreen(),
    );
  }
}

class TextoEstilizadoScreen extends StatelessWidget {
  const TextoEstilizadoScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Texto con Fuentes Variadas")),
      body: Column(
